    ...
    <div className="min-h-screen bg-[#f8fafc]">
      ...
      <div className="max-w-md mx-auto px-6 py-16">
        <div className="text-center mb-10 flex flex-col items-center">
          <EzlyLogo className="w-24 h-auto mb-6" />
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-8 shadow-sm">
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#14b8a6] focus:border-transparent outline-none transition"
                />
              </div>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 bg-[#14b8a6] text-white rounded-lg font-semibold hover:bg-[#0d9e8c] disabled:bg-gray-300 transition flex items-center justify-center gap-2"
            >
