    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-[#0f3a7d] via-[#0f3a7d] to-[#0c2e5c] pt-20 sm:pt-24 pb-24 sm:pb-36 relative overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
            ...
            <a href="#how-it-works" className="px-8 py-4 bg-white/10 backdrop-blur-sm border border-white/20 text-white font-semibold rounded-xl hover:bg-white/20 transition-all text-lg">
              See How It Works
            </a>
          </div>
      ...
      <section className="bg-white py-12 border-b border-gray-100">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <p className="text-center text-gray-400 text-sm font-medium tracking-widest uppercase mb-8">Trusted by contractors across the country</p>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 max-w-3xl mx-auto text-center">
            <div><div className="text-4xl font-bold text-[#0f3a7d]">500+</div><div className="text-sm text-gray-500 mt-1">Contractors</div></div>
            <div><div className="text-4xl font-bold text-[#0f3a7d]">12K+</div><div className="text-sm text-gray-500 mt-1">Jobs Managed</div></div>
            <div><div className="text-4xl font-bold text-[#0f3a7d]">$2.4M</div><div className="text-sm text-gray-500 mt-1">Invoiced</div></div>
            <div>
              <div className="text-4xl font-bold text-[#0f3a7d]">4.9</div>
              <div className="text-sm text-gray-500 mt-1 flex items-center justify-center gap-1"><Star className="w-3.5 h-3.5 text-yellow-500 fill-yellow-500" /> Rating</div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-[#0f3a7d] rounded-2xl p-8 sm:p-10 shadow-sm">
              ...
              <ul className="space-y-5 text-white/90">
                ...
                <li className="flex items-start gap-3"><CheckCircle className="w-5 h-5 text-[#14b8a6] flex-shrink-0 mt-0.5" />New leads auto-populate into your pipeline</li>
                <li className="flex items-start gap-3"><CheckCircle className="w-5 h-5 text-[#14b8a6] flex-shrink-0 mt-0.5" />Generate invoices in seconds, not hours</li>
                <li className="flex items-start gap-3"><CheckCircle className="w-5 h-5 text-[#14b8a6] flex-shrink-0 mt-0.5" />Real-time analytics on your most profitable work</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { icon: Settings, title: 'Business Analytics', desc: 'Track revenue, jobs, and customer trends. See exactly what is driving your growth.' },
              { icon: Zap, title: 'Easy Setup', desc: 'Get started in minutes. Import your existing customers with one click.' },
            ].map((item, idx) => (
              <div key={idx} className="group bg-white rounded-2xl p-8 border border-gray-100 hover:border-[#14b8a6]/30 hover:shadow-lg transition-all duration-300">
                <div className="w-12 h-12 bg-[#0f3a7d]/5 group-hover:bg-[#14b8a6]/10 rounded-xl flex items-center justify-center mb-5 transition-colors">
                  <item.icon className="w-6 h-6 text-[#0f3a7d] group-hover:text-[#14b8a6] transition-colors" />
                </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            {[
              ...
              { step: '2', title: 'Import your data', desc: 'Bring your existing customers and jobs. We will help you get set up fast.' },
              { step: '3', title: 'Watch your business grow', desc: 'Close more jobs. Get more leads. Spend less time on paperwork.' },
            ].map((item, idx) => (
              <div key={idx} className="text-center">
                <div className="w-16 h-16 bg-[#0f3a7d] rounded-2xl flex items-center justify-center text-2xl font-bold text-white mx-auto mb-6 shadow-lg">
                  {item.step}
                </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {[
              ...
              { name: 'Sarah K.', role: 'Plumbing Company Owner', text: 'The lead pipeline is a game changer. I follow up same day and close more jobs than ever.' },
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-5xl mx-auto">
            ...
            <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm">
              ...
              <div className="text-4xl font-bold text-[#0f3a7d] mb-1">$29<span className="text-base text-gray-400 font-normal">/mo</span></div>
              <p className="text-xs text-gray-400 mb-8">Billed monthly</p>
              <ul className="space-y-3 mb-8">
                {['Up to 25 customers', 'Basic invoicing', 'Email support'].map((f) => (
                  <li key={f} className="flex items-center gap-2 text-gray-700 text-sm"><CheckCircle className="w-4 h-4 text-[#14b8a6] flex-shrink-0" />{f}</li>
                ))}
              </ul>
              <Link href="/signup/contractor" className="block w-full py-3 text-center border-2 border-[#0f3a7d] text-[#0f3a7d] rounded-xl font-semibold hover:bg-[#0f3a7d] hover:text-white transition-colors">Get Started</Link>
            </div>
            {/* Pro */}
            <div className="bg-[#0f3a7d] rounded-2xl p-8 relative shadow-xl ring-2 ring-[#14b8a6]/30">
              <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-[#14b8a6] text-white text-xs font-bold px-4 py-1 rounded-full tracking-wide">MOST POPULAR</div>
              <h3 className="text-lg font-bold text-white mb-1">Pro</h3>
              <p className="text-white/60 text-sm mb-6">For growing contractors who want more.</p>
              <div className="text-4xl font-bold text-white mb-1">$49<span className="text-base text-white/40 font-normal">/mo</span></div>
              <p className="text-xs text-white/40 mb-8">Billed monthly</p>
              <ul className="space-y-3 mb-8">
                {['Unlimited customers', 'Full invoicing + payments', 'Job management + scheduling', 'Business analytics'].map((f) => (
                  <li key={f} className="flex items-center gap-2 text-white text-sm"><CheckCircle className="w-4 h-4 text-[#14b8a6] flex-shrink-0" />{f}</li>
                ))}
              </ul>
              <Link href="/signup/contractor" className="block w-full py-3 text-center bg-[#14b8a6] text-white rounded-xl font-semibold hover:bg-[#0d9e8c] transition-colors">Get Started</Link>
            </div>
            {/* Business */}
            <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm">
              ...
              <div className="text-4xl font-bold text-[#0f3a7d] mb-1">$149<span className="text-base text-gray-400 font-normal">/mo</span></div>
              <p className="text-xs text-gray-400 mb-8">Billed monthly</p>
              <ul className="space-y-3 mb-8">
                {['Everything in Pro', 'Multi-user access', 'API access', 'Dedicated support'].map((f) => (
                  <li key={f} className="flex items-center gap-2 text-gray-700 text-sm"><CheckCircle className="w-4 h-4 text-[#14b8a6] flex-shrink-0" />{f}</li>
                ))}
              </ul>
              <Link href="/signup/contractor" className="block w-full py-3 text-center border-2 border-[#0f3a7d] text-[#0f3a7d] rounded-xl font-semibold hover:bg-[#0f3a7d] hover:text-white transition-colors">Contact Sales</Link>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          ...
          <div className="space-y-3">
            {[
              ...
              { q: 'How does EZLY fit in?', a: 'EZLY drives high-quality leads directly to your Prolink dashboard. When a service request comes in through EZLY, it auto-populates into your pipeline — no extra work needed.' },
              { q: 'Can I import my existing customers?', a: 'Yes! Import your existing customer list via CSV upload. Most contractors are up and running in under 15 minutes.' },
              { q: 'Is there a free trial?', a: 'Absolutely. Start with a 14-day free trial. No credit card required. Cancel anytime.' },
              { q: 'What happens after my trial ends?', a: 'Choose the plan that fits your needs. Monthly or annual billing with discounts for annual subscriptions.' },
              { q: 'Is my data secure?', a: 'Yes. We use bank-level 256-bit SSL encryption, daily backups, and SOC-2 compliant hosting.' },
            ].map((item, idx) => (
              <button key={idx} onClick={() => setOpenFaq(openFaq === idx ? null : idx)} className="w-full text-left bg-white rounded-xl p-6 border border-gray-100 hover:border-gray-200 transition-colors">
                ...
                {openFaq === idx && <p className="text-gray-600 text-sm mt-3 leading-relaxed">{item.a}</p>}
              </button>
            ))}
          </div>
        </div>
      ...
      <section className="bg-[#0f3a7d] py-20 sm:py-28 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-white/70 text-lg mb-10 max-w-2xl mx-auto">Join hundreds of contractors who have already made the switch to Prolink.</p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/signup/contractor" className="px-8 py-4 bg-[#14b8a6] text-white font-bold rounded-xl hover:bg-[#0d9e8c] transition-all shadow-lg text-lg flex items-center gap-2 group">
              Start Your Free Trial
              <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </Link>
            <Link href="/contact" className="px-8 py-4 bg-transparent border-2 border-white/30 text-white font-bold rounded-xl hover:bg-white/10 transition-all text-lg">
              Talk to Sales
            </Link>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="py-16 grid grid-cols-2 sm:grid-cols-5 gap-8">
            <div className="col-span-2">
              ...
              <p className="text-gray-500 text-sm leading-relaxed max-w-xs mb-6">CRM and workflow management built for modern contractors.</p>
              <a href="mailto:ezly.home@gmail.com" className="text-[#14b8a6] text-sm font-semibold hover:text-[#0d9e8c] transition">ezly.home@gmail.com</a>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                ...
                <li><Link href="/blog" className="text-gray-500 hover:text-[#0f3a7d] transition">Blog</Link></li>
                <li><Link href="/contact" className="text-gray-500 hover:text-[#0f3a7d] transition">Contact</Link></li>
                <li><Link href="/privacy" className="text-gray-500 hover:text-[#0f3a7d] transition">Privacy</Link></li>
              </ul>
            </div>
            <div>
